		...
		<div class="col-md-12">
			...
			<div class="box ">
				...
				<div class="box-body">
					...
					@endif
					<form action="{{ url('/store-profile/'.$session->id) }}" method="post" role="form" accept-charset="UTF-8" enctype="multipart/form-data">
				        ...
				        <div class="col-md-4">
					        <div class="form-group">
								...
								<br>						
								<p class="text-center">
									<img id="preview_img" class="img img-thumbnail" style="margin-top: 25px; max-height:200px" src="{{ !empty($row->photo) ? asset(GLobalHelpers::checkImage($row->photo)) : '' }}">
								</p>					        	
					        </div>
				        </div>
				        <div class="col-md-12">
						<div class="box-footer">
							<div class="pull-right">
								<button class="btn btn-danger" type="button" id="reset">
									<i class="fa fa-refresh" style="margin-right:5px"></i> Batal
								</button>
